...
CATALOG = {
    ...
    "apm_unauth_ingestion": {"cwe": "CWE-306", "title": "Elastic APM Server accepts telemetry ingestion without authentication",
                           "vector": "AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:H/A:N"},
    "apm_central_config_exposed": {"cwe": "CWE-306", "title": "Elastic APM agent central configuration readable without authentication",
